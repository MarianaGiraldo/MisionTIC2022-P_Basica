...
public class clsDistanciaRed {
    ...
    public double calcular_distancia_c1_a1(){
    ...
    public double calcular_distancia_a1_ch(){
    ...
    public double calcular_distancia_ch_a2(){
    ...
    public double calcular_distancia_a2_c2(){
